...
# Dense sampling of reachable workspace
...
# ----------- Interactive pose slider ------------
@interact(q1=FloatSlider(min=q1_lim[0], max=q1_lim[1], step=0.05, value=0, description='q1 [rad]'),
          q2=FloatSlider(min=q2_lim[0], max=q2_lim[1], step=0.05, value=0, description='q2 [rad]'))
